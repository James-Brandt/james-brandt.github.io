...
<p class="text-center" style="font-size:0.85rem;"><strong>Figure 1:</strong> Final profile of optimised shape showing smooth axisymmetric curvature, and a graph displaying the change in drag over each generation</p>
...
<p class="text-center" style="font-size:0.85rem;"><strong>Figure 2:</strong> Drag evolution over 1000 generations of Differential Evolution and CMA-ES.</p>
